...
GREEN_TAXI_GCP_PATH_TEMPLATE="raw/green_tripdata/{{ execution_date.strftime(\'%Y\') }}/green_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet"
...
download_upload_gcp(
        ...
        ,local_gcp_path_template=GREEN_TAXI_GCP_PATH_TEMPLATE
    )
...
FHV_TAXI_GCP_PATH_TEMPLATE="raw/fhv_tripdata/{{ execution_date.strftime(\'%Y\') }}/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet"
...
download_upload_gcp(
        ...
        ,local_gcp_path_template=FHV_TAXI_GCP_PATH_TEMPLATE
    )
